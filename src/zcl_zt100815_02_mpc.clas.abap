class ZCL_ZT100815_02_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZT100815_02_MPC===========CP' ##NO_TEXT.
...
CLASS ZCL_ZT100815_02_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZT100815_02_SRV' ).
...
lo_association->set_label_from_text_element( iv_text_element_symbol = '002' iv_text_element_container = gc_incl_name ). "#EC NOTEXT
...
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'CustomersToOrdersSet'                         "#EC NOTEXT
 ...
 lo_association = model->create_association(
                            ...
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
lo_association->set_label_from_text_element( iv_text_element_symbol = '003' iv_text_element_container = gc_incl_name ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250803090759'.                  "#EC NOTEXT
